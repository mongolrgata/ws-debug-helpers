...
(function(b, j) {
   if (b.cleanData) {
      ...
      b.cleanData = function(a) {
         /**
          * cleanData ���������� ��� ������ empty � remove
          * ����� ���������� ������ �� ������� �������� ����������� ����� - ws-jquery-ui-widget-container
          * ���� ����� ���� �� �������� - ������ triggerHandler (�������� � ����, ��� ���������� ���������� �������)
          * ��. :222
          */
         for (var c = 0,d; (d = a[c]) != null; c++) {
            if(!('className' in d) ||
               (d.className && typeof d.className == 'string' && d.className.indexOf("ws-jquery-ui-widget-container") !== -1))
      ...
      b.fn.remove = function(a, c) {
         return this.each(function() {
            // �������� �� * � ������ �� ��������, � ������� ���� �����-��������� (��. :222)
            if (!c)if (!a || b.filter(a, [this]).length)b(".ws-jquery-ui-widget-container", this).add([this]).each(function() {
   ...
   b.Widget.prototype = {widgetName:"widget",
      widgetEventPrefix:"",options:{disabled:false},_createWidget:function(a, c) {
         ...
         this.element = b(c);
         // ����������� �����-��������� (��� ��� -- ������)
         this.element.addClass('ws-jquery-ui-widget-container');
...
(function ($, undefined) {
   ...
   $.extend(Datepicker.prototype, {markerClassName:"hasDatepicker", maxRows:4, log:function () {
      ...
      var d = a.dpDiv.outerWidth(), e = a.dpDiv.outerHeight(), f = a.input ? a.input.outerWidth() : 0, g = a.input ? a.input.outerHeight() : 0, h = document.body.scrollWidth + $(document).scrollLeft(), i = document.body.scrollHeight + $(document).scrollTop();
